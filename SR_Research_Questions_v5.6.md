...
**Output cuối:** `SR_Bibliometric_v5.6.md` + 5 PNG.
...
**Output cuối:** `SR_Research_Agenda_v5.6.md`.
...
|----|------|----------------|----------------|
| RQ1 | 1a–1e | Bước 16 (Bibliometric) | `SR_Bibliometric_v5.6.md` + 5 PNG |
...
| File | Quan hệ |
|------|----------|
| `WorkPlan_v5.6_FINAL.md` §0.7 | Reference tới file này — KHÔNG duplicate RQ |
| `SR_Search_Strategy_v5.6_FINAL.md` §1.3, §1.4 | Reference tới file này — Strategy chỉ mô tả how to search |
| `SR_Eligibility_Criteria_v5.6.md` | IC2-IC5 align với 5 lĩnh vực vận hành (RQ2); Borderline 6 align với RQ4d |
| `SR_Data_Extraction_Form_v5.6.md` Group D + D' | Field `area_*`, `port_size`, `port_vintage`, `realistic_ceiling`, `l5_evidence` align với RQ2, RQ4d, RQ5b |
| `osf_release/SR_Research_Questions.md` | Bản công khai (đã strip nhãn nội bộ) — sync với file này |

---

*SR_Research_Questions_v5.6.md — v1.0 — 2026-05-08 — Single Source of Truth*
