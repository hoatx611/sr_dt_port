...
**Anchor:** `SR_Research_Questions.md` v1.0 — IC2-IC5 align với 5 lĩnh vực vận hành (RQ2)
...
| File | Quan hệ |
|------|---------|
| `SR_Research_Questions.md` | RQ doc — IC2-IC5 align với 5 lĩnh vực vận hành (RQ2) + Borderline 6 align với RQ4d |
| `WorkPlan.md` | Bước 2 (soạn deliverable này); Bước 8 (Pha A + Pha B áp T/A); Bước 9 (Fulltext áp Lớp 2) |
| `SR_Search_Strategy.md` §4.12 | T&F-specific exclusion list chi tiết |
| `SR_PRISMA_Checklist.md` | Item 5 mapping |
| `SR_Data_Extraction_Form.md` | Group D (5 boolean lĩnh vực) + Group D' (port_size, port_vintage) align với IC2 + Borderline 6 |
...
*SR_Eligibility_Criteria.md — v1.0 — 2026-05-08 — anchored on RQ_v1.0*
