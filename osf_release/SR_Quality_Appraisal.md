...
Bước 6: Ghi vào quality_appraisal.csv
...
File output: `quality_appraisal.csv`
...
| File | Quan hệ |
|------|---------|
| `SR_Classification_Rubric.md` | Chạy song song — cùng study, cùng Bước 12–13 |
| `SR_Data_Extraction_Form.md` | Group E (Quality scores) nhận data từ rubric này |
| `WorkPlan_FINAL.md` | Bước 13 + Bước 14.2 |
| `SR_PRISMA_Checklist.md` | Item 11 (Quality assessment methods) |

---

*SR_Quality_Appraisal.md — v1.0 — 2026-05-14 — NCS HoaTX*
