...
**Anchor:** `SR_Research_Questions.md` v1.0 — bộ 5 RQ với RQ4 5 chiều + Realistic Ceiling
...
> **Bộ 5 RQ chính thức** lưu trong `SR_Research_Questions.md` v1.0. Strategy chỉ mô tả *how to search* — KHÔNG lặp định nghĩa RQ.
...
|-------|-------------|----------|
| **Lùi (backward)** | Rà references của 6 hạt giống → khử trùng lặp với pool đã có → đánh giá tóm tắt theo IC/EC | `snowball_backward.csv` |
| **Tiến (forward)** | "Cited by" Google Scholar cho S1, S2, S4, S5 (S3, S6 quá mới) | `snowball_forward.csv` |
...
**Thực hiện:** rà mục lục từng tạp chí giai đoạn 2024–2026 trước Bước 22 (Submit). Output: `hand_search.csv`.
...
Danh sách 78 seeds lưu trong internal knowledge graph mục "Seed list cho recall validation".
...
Cú pháp Scopus đầy đủ lưu trong internal knowledge graph mục "Truy vấn phân tích độ nhạy".
...
| File | Vai trò |
|------|---------|
| `SR_Research_Questions.md` v1.0 | Single Source of Truth cho RQ — Strategy reference §1.3 + §1.5 |
| `WorkPlan.md` | Bước 4–6 thực thi tìm kiếm; Bước 15 sensitivity; Bước 16 bibliometric |
| `SR_Eligibility_Criteria.md` | 28 mã EC/IC + 6 borderline rules + T&F whitelist |
| `SR_Screening_Protocol.md` | Pha A Python `screening.py` + Pha B Rayyan |
| `SR_PRISMA_Checklist.md` | Items 6, 7, 8, 13c, 13f, 16a, 23c, 24a–c |
...
*SR_Search_Strategy.md — v1.0 — 2026-05-08 — anchored on RQ_v1.0 (`SR_Research_Questions.md`) + PRISMA 2020 + PRISMA-S + PRESS + Kitchenham 2007*
