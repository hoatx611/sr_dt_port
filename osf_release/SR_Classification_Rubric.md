...
**File:** SR_Classification_Rubric.md
...
**Anchor:** `SR_Research_Questions.md` v1.0 §II (Khung lý thuyết 2 lớp)
**Dùng tại:** Bước 12 (phân loại mỗi study sau extraction Bước 11)

> Rubric này áp dụng sau khi đọc toàn văn. Mọi quyết định phân loại ghi vào `SR_Data_Extraction_Form.md` Group C + D + D'. Bất đồng ↔ borderline ghi vào `borderline_decisions_log.md`.
...
Theo Eligibility Criteria Borderline 6 (`SR_Eligibility_Criteria.md` §VI Rule 6).
...
| File | Quan hệ |
|------|---------|
| `SR_Research_Questions.md` §II | Lý thuyết L1-L5 + Realistic Ceiling |
| `SR_Eligibility_Criteria.md` §VI | Borderline 6 (vintage rule) |
| `SR_Data_Extraction_Form.md` | Group C/D/D' nhận data từ rubric này |
| `SR_Quality_Appraisal.md` | Chạy song song với classification Bước 12–13 |
| `WorkPlan_FINAL.md` | Bước 12 |

---

*SR_Classification_Rubric.md — v1.0 — 2026-05-14 — NCS HoaTX*
