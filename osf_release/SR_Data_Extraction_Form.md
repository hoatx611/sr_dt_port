...
**Anchor:** `SR_Research_Questions.md` v1.0 — mỗi nhóm trường align với RQ tương ứng
...
Mẫu trích xuất chuẩn hoá data từ mỗi included study → file `extraction.csv` để phân tích ở Bước 16 (bibliometric) + Bước 17 (synthesis).
...
NCS chấm tuần tự included pool theo thứ tự ưu tiên (cảng VN/ĐNÁ → cảng nguồn lực hạn chế → các bài còn lại). Output: `extraction.csv` — 40 cột × N rows.
...
| File | Quan hệ |
|------|---------|
| `SR_Research_Questions.md` | RQ doc — mỗi field align với RQ qua bảng §V |
| `WorkPlan.md` | Bước 11 (áp form), Bước 12 (Maturity classification), Bước 17 (synthesis) |
| `SR_Eligibility_Criteria.md` | IC2 ↔ Group D 5 areas; Borderline 6 ↔ port_vintage |
| `SR_Classification_Rubric.md` | Rubric chi tiết cho maturity_primary (L1-L5) — sẽ tạo ở Bước 12 |
| `SR_Quality_Appraisal.md` | Form Quality Appraisal Q1-Q8 song song — tạo ở Bước 13 |

---

*SR_Data_Extraction_Form.md — v1.0 — 2026-05-08 — anchored on RQ_v1.0*
