...
**File:** SR_PRISMA_FlowDiagram_v5.6.md
...
**Anchor:** `SR_Search_Results_Summary_v5.6.md` v1.1 (nguồn số liệu)
...
NCS sẽ review thủ công 5.345 records trên Rayyan Essentials, áp dụng đầy đủ 28 mã EC/IC từ `SR_Eligibility_Criteria_v5.6.md`. Intra-rater reliability: 50 records chấm lần 2 sau ≥ 14 ngày → Cohen's κ mục tiêu ≥ 0.75 (Bước 14).
...
| File | Quan hệ |
|------|---------|
| `SR_Search_Results_Summary_v5.6.md` | Nguồn số liệu §2.1–2.3 |
| `SR_Eligibility_Criteria_v5.6.md` | 28 mã EC/IC dùng trong §2.3–2.4 |
| `SR_Deviation_Log_v5.6.md` | DEV-004 (Q10 Resolved) — không còn ảnh hưởng §2.1 |
| `dedup_report.txt` | Chi tiết Lớp 1/2/3 cho §2.2 |
| `03_screening/screening_distribution.txt` | Chi tiết EC codes cho §2.3 |
| `SR_PRISMA_Checklist_v5.6.md` | Item 16a/16b cross-reference |

---

*SR_PRISMA_FlowDiagram_v5.6.md — v1.1 — 2026-05-15 — NCS HoaTX*
