...
| Item | Mô tả PRISMA 2020 | Yêu cầu | Section/Page | Trạng thái |
|------|-------------------|---------|--------------|------------|
| **5** | **Eligibility criteria** — Xác định tiêu chí IC/EC đầy đủ với lý do | 28 mã IC/EC (IC1–IC5, EC1–EC-STRUCT), PICOC, 6 borderline rules | §3.1 Methods | ⬜ Bước 18 |
| **6** | **Information sources** — Liệt kê tất cả nguồn tìm kiếm, ngày chạy | Scopus, IEEE, GS, Springer, T&F + ngày 2026-05-10; Q10 Vintage note | §3.2 Methods | ⬜ Bước 18 |
| **7** | **Search strategy** — Trình bày ít nhất 1 full search string (đủ để tái lập) | Full query Q1 CORE NARROW + mô tả strategy + Supplementary strategy | §3.2 Methods + Supplementary | ⬜ Bước 18 |
| **8** | **Selection process** — Mô tả ai/bao nhiêu người sàng lọc, cách giải quyết bất đồng | Single reviewer (NCS) + Pha A regex + Pha B Rayyan + intra-rater κ | §3.3 Methods | ⬜ Bước 18 |
...
| Item | Mô tả PRISMA 2020 | Yêu cầu | Section/Page | Trạng thái |
|------|-------------------|---------|--------------|------------|
| **14** | **Study selection** — PRISMA flow diagram + số loại trừ theo lý do mỗi tầng | PRISMA 2020 flow diagram với số liệu thực (sau Bước 9) + Table EC reasons | §4.1 Results + Figure 1 | ⬜ Bước 10 + 18 |
...
| **16a** | **Risk of bias in studies — assessment** — Trình bày đánh giá chất lượng từng study | Kitchenham scores (Q1–Q8) cho mỗi study trong Supplementary + summary Figure | §4.3 Results + Supplementary | ⬜ Bước 13 + 18 |
| **16b** | **Risk of bias in studies — presentation** | Distribution of quality levels (High/Medium/Low) | §4.3 Results | ⬜ Bước 13 + 18 |
...
| **23c** | **Amendments** — Ghi nhận sai lệch so với protocol | DEV-001/002/003 (Resolved) + DEV-004 (Open — Q10 Vintage) + intra-rater κ results | Methods §3 hoặc Supplementary | 🔄 DEV-004 Open |
...
| Methods | 5–13e | 1 (item 11) | 0 | 7 | 2 (12, 13e) |
| Results | 14–22 | 0 | 0 | 6 | 3 (20, 21, 22) |
| Other | 23–27 | 3 (23a,23b,25) | 2 (23c,27) | 4 | 0 |
| **Tổng** | **27 items** | **4** | **2** | **21** | **8** |
...
|---------|------|----------|
| **v1.0** | 2026-05-14 | Tạo ban đầu — 27 items đầy đủ; 8 N/A justified; section mapping; trạng thái hiện tại |
